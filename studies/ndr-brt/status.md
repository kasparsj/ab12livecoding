# ndr-brt Study Status

## Complete

- Track README and source caveat.
...
- `foldEvery`, `mask`, `slice`, `hpf`, and `hresonance` need local version checks.
...
- Original source uses custom synthdefs, custom parameters, private samples, and
  MIDI setup; local files are translations of method, not reproductions.
