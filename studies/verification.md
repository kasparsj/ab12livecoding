...
| File | Status | Notes |
| --- | --- | --- |
| `studies/kindohm/tidal/kindohm-01-daily-sketch-and-reuse.tidal` | Not tested live | Confirm `setcps (140/60/4)`, `resetCycles`, and stock samples. |
| `studies/kindohm/tidal/kindohm-02-transformer-chains.tidal` | Not tested live | Confirm `setcps (140/60/4)`, `foldEvery`, and `slowspread`. |
| `studies/kindohm/tidal/kindohm-03-sample-index-machines.tidal` | Not tested live | Confirm `setcps (150/60/4)` and `samples` fallback. |
| `studies/kindohm/tidal/kindohm-04-time-effects-and-sections.tidal` | Not tested live | Confirm `setcps (120/60/4)`, `within`, `stut`, `trunc`, delay controls. |
| `studies/kindohm/tidal/kindohm-05-melody-and-hardware-translation.tidal` | Not tested live | Confirm `setcps (120/60/4)` and `superpiano` fallback. |
| `studies/kindohm/tidal/kindohm-06-archival-idioms-and-helper-compression.tidal` | Not tested live | Confirm `setcps (140/60/4)`, `\|+\|`, `stut'`, `rarely`, `sometimesBy`, `irand`, and conservative gain. |
...
| `studies/ndr-brt/tidal/ndr-brt-06-control-sieves-and-timbre.tidal` | Not tested live | Confirm `sh`, `so`, `rinse`, masks, `struct`, optional `cF` comments, and stock timbre controls. |
