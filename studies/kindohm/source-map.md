...
| --- | --- | --- | --- |
| [`readme.md`](https://github.com/kindohm/365tidalpatterns/blob/master/readme.md) | Daily practice archive and custom-sample caveat. | [`README.md`](README.md), [`tidal/00-open-this-first.tidal`](tidal/00-open-this-first.tidal) | Track overview and startup prompts. |
